...
"""
Варианты запросов с использованием этой схемы:

{
  ...
  filterTodosByIsactive(boolValue:true){
    body
  }
  filterProjectsByUser(username:"JarWint"){
    name
  }
}

mutation updateTodo {
    updateTodo(condition: false, id: 15) {
    todo {
        id
        body
        isActive
